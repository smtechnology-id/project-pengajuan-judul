        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card widget-flat text-bg-purple">
                <div class="card-body">
                    ...
                    <a href="{{route('kaprodi.dosen')}}" class="btn btn-light">Detail</a>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card widget-flat text-bg-pink">
                <div class="card-body">
                    ...
                    <a href="{{route('kaprodi.pengajuan')}}" class="btn btn-light">Detail</a>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card widget-flat text-bg-info">
                <div class="card-body">
                    ...
                    <a href="{{route('kaprodi.jadwal')}}" class="btn btn-light">Detail</a>
